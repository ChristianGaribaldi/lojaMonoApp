...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, nome: @produto.nome, precoUnitario: @produto.precoUnitario }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { descricao: @produto.descricao, nome: @produto.nome, precoUnitario: @produto.precoUnitario }
    assert_redirected_to produto_path(assigns(:produto))
  end
